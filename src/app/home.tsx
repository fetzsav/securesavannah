...
>
    ...
    <div className="absolute top-0 left-0 right-0 z-20 p-8">
        {/* This container now centers its content on mobile */}
    ...
    <div className="relative z-10 max-w-7xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center py-24 lg:py-0">
        <div className="text-white text-center lg:text-left">
            ...
            {/* This container now wraps its content and uses gap for spacing */}
        ...
        {/* This second grid item is hidden on mobile and appears on desktop */}
...
<div className="py-20 bg-gradient-to-br from-slate-900 to-blue-900">
    <div className="max-w-7xl mx-auto px-8">
        ...
        {/* This grid is now responsive: 1 column on mobile, 3 on large screens */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {/* Package 1 */}
            <div className="flex flex-col bg-slate-800/80 backdrop-blur-sm rounded-2xl p-8 border border-slate-700">
                <div className="relative mb-6">
                    <div className="absolute -top-4 -right-4 bg-green-500 text-white text-sm px-3 py-1 rounded-full">Save 15%</div>
...
<div className="py-20 bg-slate-900">
    <div className="max-w-7xl mx-auto px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center">
            ...
            <div>
                <h2 className="text-3xl lg:text-4xl font-bold text-white mb-8">Understanding Your Security System Options</h2>

                {/* This is now a 2x2 responsive grid for the features */}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                    {/* Item 1: Indoor Monitoring */}
                    <div className="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-blue-200">Comprehensive interior surveillance coverage to keep an eye on what matters most inside.</p>
                        </div>
                    </div>

                    {/* Item 2: AI Object Detection */}
                    <div className="flex items-start space-x-4">
                        <div className="w-12 h-12 bg-blue-600 rounded-lg flex items-center justify-center flex-shrink-0">
                        ...
                        <div>
                            ...
                            <p className="text-blue-200">Smart recognition to reduce false alerts and provide meaningful notifications.</p>
                        </div>
                    </div>

                    {/* Item 3: Outdoor Protection */}
                    <div className="flex items-start space-x-4">
                        <div className="w-12 h-12 bg-blue-600 rounded-lg flex items-center justify-center flex-shrink-0">
                    ...
                    <div className="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-blue-200">Monitor live feeds and control your system from anywhere with our intuitive mobile app.</p>
                        </div>
                    </div>
                </div>
            </div>
